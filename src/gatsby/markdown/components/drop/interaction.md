...
Use `<div class="xt-backdrop bg-black opacity-25"></div>` inside `.xt-drop` to add a customizzable backdrop. Use the class `xt-active:z-drop` to have the button above the backdrop.
