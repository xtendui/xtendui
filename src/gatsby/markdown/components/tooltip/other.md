...
| Option                  | `a11y.role:String\|false`                          | `'tooltip'`        | Inject `role` and related attributes, can be `'tablist'`, `'popup'`, `'dialog'`, `'tooltip'`, `'carousel'`            |
...
| Option                  | `a11y.items:String\|false`                          | `false`        | Navigate current active target query with focus           |
