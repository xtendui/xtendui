...
<div class="list list--default list-space--small align-items--center demo-source-from">
  <div data-xt-overlay>
    ...
    <div class="overlay overlay--default overlay--overflow-y">
  ...
  <div data-xt-overlay>
    ...
    <div class="overlay overlay--default overlay-screen overlay--overflow-y">
      <div class="overlay-container">
        <div class="overlay-inner">
          <div class="overlay-design"></div>
          <div class="overlay-close xt-fixed--check">
  ...
  <div data-xt-overlay>
    ...
    <div class="overlay overlay--default overlay-position overlay-position-right overlay-position--right overlay--overflow-y">
      <div class="overlay-container">
        <div class="overlay-inner">
          <div class="overlay-design"></div>
          <div class="overlay-close xt-fixed--check">
