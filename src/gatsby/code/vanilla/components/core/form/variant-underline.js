...
<form class="text-sm">
  <div class="xt-row xt-row-x-6 xt-row-y-4">
    ...
    <div class="w-full">
      ...
      <input type="text" class="xt-input ${classes.inputUnderline()}" aria-label="Input" placeholder="Input" disabled>
    </div>
    ...
    <div class="w-full">
      ...
      <textarea class="xt-input xt-textarea ${classes.inputUnderline()} h-24 resize-vertical" aria-label="Textarea" placeholder="Textarea"></textarea>
    </div>
