  ...
  <div class="w-full">
    <div class="card ${cardDefaultFull()}">
      <div class="md:card-group">
        <div class="card-block py-8 px-0 pt-0 sm:pb-0 sm:pr-6 md:w-7/12">
        ...
        <div class="border-t md:w-5/12 sm:border-t-0 sm:border-l border-solid border-gray-500">
          <div class="card-block py-8 px-0 sm:pt-0 sm:pl-6">
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer non feugiat lorem, nec volutpat turpis.</p>
          </div>
          <div class="card-block py-8 px-0 pb-0 sm:pt-6 sm:pl-6 border-t border-solid border-gray-500">
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer non feugiat lorem, nec volutpat turpis.</p>
          </div>
        </div>
      </div>
