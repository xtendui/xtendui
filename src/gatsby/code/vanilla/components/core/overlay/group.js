        ...
        <div class="overlay-inner">
          ...
          <div class="card ${cardDefaultOverlay()}">
            ...
            <div class="md:card-group">
              ...
              <div class="card-block py-8 px-9 md:w-5/12 rounded-b-md sm:rounded-b-none sm:rounded-r-md bg-gray-400">
                <p><strong>Lorem ipsum</strong> dolor sit amet, <a href="#">consectetur adipiscing</a> elit. Nullam suscipit, velit eu tristique mollis, dui felis dictum turpis, a auctor est odio ac diam. Sed mauris augue, sagittis vitae magna eget, vehicula scelerisque elit.</p>
              </div>
            </div>
          </div>
      ...
      <div class="overlay-container max-w-5xl">
        <div class="overlay-inner">
          ...
          <div class="card ${cardDefaultOverlay()}">
            ...
            <div class="md:card-group">
              <div class="card-block py-8 px-9 md:w-7/12 bg-gray-400 sm:rounded-tl-md">
                <div class="h3">Lorem ipsum</div>
                <p><strong>Lorem ipsum</strong> dolor sit amet, <a href="#">consectetur adipiscing</a> elit. Nullam suscipit, velit eu tristique mollis, dui felis dictum turpis, a auctor est odio ac diam. Sed mauris augue, sagittis vitae magna eget, vehicula scelerisque elit.</p>
              </div>
              <div class="md:w-5/12">
                <div class="card-block py-8 px-9 bg-gray-500 sm:rounded-tr-md">
