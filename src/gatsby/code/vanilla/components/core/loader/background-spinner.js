...
<div class="xt-list xt-list-3 items-center justify-center">
  ...
  <div class="xt-card rounded-md ${cardDefault()}">
    ...
    <div class="xt-loader absolute z-top inset-0 rounded-inherit overflow-hidden bg-white bg-opacity-75">
  ...
  <button type="button" class="xt-button text-xs py-2 px-3.5 rounded-md ${buttonDefault()}">
    Lorem ipsum
    <span class="xt-loader absolute z-top inset-0 rounded-inherit overflow-hidden bg-white bg-opacity-75">
