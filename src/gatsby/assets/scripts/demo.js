...
const populateDemo = (container, i) => {
  ...
  container.prepend(
    Xt.createElement(
      '<div class="gatsby_demo_tabs"><div class="gatsby_demo_tabs_left list list-1"></div><div class="gatsby_demo_tabs_right list list-1"></div></div>'
    )
  )
...
<div data-xt-tooltip="{ targets: '#tooltip--show-code--on-${showCodeUid}, #tooltip--show-code--off-${showCodeUid}', position: 'bottom-end' }">
  ...
  <div id="tooltip--show-code--on-${showCodeUid}" class="tooltip group" data-xt-duration="300">
    <div class="tooltip-sm rounded shadow-tooltip ${cardBlack()} transform transition duration-300 opacity-0 translate-y-2 group-active:opacity-100 group-active:translate-y-0">
      Show Code
    </div>
  </div>
...
<div class="gatsby_demo_code">
  <div class="gatsby_demo_code_inner">
    <div class="gatsby_demo_code_tabs">
      <div class="gatsby_demo_code_tabs_left list list-1"></div>
      <div class="gatsby_demo_code_tabs_right list list-1">
