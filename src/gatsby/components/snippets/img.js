...
export default ({ classes = '', ratio = null, height = null }) => {
  ...
  }><div class="media-inner"><img class="media ${classes}" src="/img.svg" loading="lazy" alt=""/></div></div>`
}

export const alt = ({ classes = '', ratio = null, height = null }) => {
  return `<div class="media-container"${
    ratio ? ' style="padding-bottom:' + ratio + '"' : height ? ' style="height:' + height + '"' : ''
  }><div class="media-inner"><img class="media ${classes}" src="/img-alt.svg" loading="lazy" alt=""/></div></div>`
}
