...
export default ({ classes = '', ratio = null, height = null, loading = 'lazy' }) => {
  ...
  }><div class="media-inner"><img class="media" src="/img.svg" loading="${loading}" alt=""/></div></div>`
}

export const alt = ({ classes = '', ratio = null, height = null, loading = 'lazy' }) => {
  return `<div class="media-container ${classes}"${
    ratio ? ' style="padding-bottom:' + ratio + '"' : height ? ' style="height:' + height + '"' : ''
  }><div class="media-inner"><img class="media" src="/img-alt.svg" loading="${loading}" alt=""/></div></div>`
}
