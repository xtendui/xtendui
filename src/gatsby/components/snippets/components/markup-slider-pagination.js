    ...
    <div class="slide w-6/12 sm:w-4/12 opacity-50 active:opacity-100">
      <div class="card rounded-md ${cardSlide()}">
        ...
        <nav class="slider-pagination slider-ui w-full list list-2 pt-4 items-center justify-center">
          <button type="button" class="btn text-2xs py-2 px-3.5 active:px-5 h-5 rounded-full text-black font-sans font-semibold leading-snug tracking-wider uppercase bg-gray-200 hover:bg-gray-300 active:bg-gray-400 transition-all xt-ignore" data-xt-pag title="Slide xt-num">
            xt-content
          </button>
        </nav>
      </div>
