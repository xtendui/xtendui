...
<div class="xt-sticky">
  <div class="xt-card ${classes.cardSm()} ${classes.cardPrimary()}">
    <div class="xt-list xt-list-3">
      ...
      <a href="#anchor-overlay-0" class="xt-button ${classes.buttonMd()} rounded-md ${classes.buttonPrimary()}" data-xt-overlay="{ targets: '#demo--overlay-scrolltoanchor' }">
        #0 overlay
      </a>
      <a href="#anchor-overlay-1" class="xt-button ${classes.buttonMd()} rounded-md ${classes.buttonPrimary()}" data-xt-overlay="{ targets: '#demo--overlay-scrolltoanchor' }">
        #1 overlay
      </a>
      <a href="#anchor-overlay-2" class="xt-button ${classes.buttonMd()} rounded-md ${classes.buttonPrimary()}" data-xt-overlay="{ targets: '#demo--overlay-scrolltoanchor' }">
        #2 overlay
      </a>
    </div>
  </div>
  ...
  <div class="xt-overlay-container p-0">
    <div class="xt-overlay-inner">
      ...
      <div class="xt-sticky">
        <div class="xt-card ${classes.cardSm()} ${classes.cardPrimary()}">
          <div class="xt-list xt-list-3">
            <a href="#anchor-overlay-0" class="xt-button ${classes.buttonMd()} rounded-md ${classes.buttonPrimary()}">
              #0
            </a>
            <a href="#anchor-overlay-1" class="xt-button ${classes.buttonMd()} rounded-md ${classes.buttonPrimary()}">
              #1
            </a>
            <a href="#anchor-overlay-2" class="xt-button ${classes.buttonMd()} rounded-md ${classes.buttonPrimary()}">
              #2
            </a>
          </div>
        </div>
