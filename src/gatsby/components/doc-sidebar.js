  ...
  render() {
    ...
    return (
      <div className="gatsby_site_article_sidebar">
        ...
        <nav className="gatsby_site_article_sidebar_listing">
              ...
              {page.categories.category.map((category, i) => (
                <div key={i}>
                  <div className="gatsby_site_article_sidebar_cat">
                    <div
                      className={`btn gatsby_btn--site_article_sidebar gatsby_btn--site_article_sidebar--cat ${
                    ...
                    <div
                      className={`gatsby_site_article_sidebar_sub active ${
                        !page.post.frontmatter.categories
                          ? page.post.frontmatter.title === category.title.split('-').pop()
                            ? 'active'
                            : ''
