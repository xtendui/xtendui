export const classes = {
  ...
  buttonCode: () =>
    'text-opacity-70 font-medium leading-tight tracking-normal capitalize rounded-md border-gray-100 bg-gray-100 transition hover:text-opacity-100 in:border-white in:bg-white in:text-opacity-100',
  buttonCodeWhite: () =>
  ...
  checkContent: () => 'ml-4',
  checkGray: () => 'bg-gray-200 border border-transparent transition-all checked:bg-primary-500',
  checkPrimary: () => 'bg-primary-800 bg-opacity-25 border border-transparent transition-all checked:bg-primary-600',
  checkRadius: () => 'rounded-md',
  radioGray: () => 'bg-gray-200 border border-transparent transition-all checked:bg-primary-500',
  radioPrimary: () => 'bg-primary-800 bg-opacity-25 border border-transparent transition-all checked:bg-primary-600',
  ...
  note: () => 'text-gray-900 text-opacity-70 text-xs leading-snug',
  // headers
  h1Display: () => {
