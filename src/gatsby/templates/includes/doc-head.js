            ...
            <div className="gatsby_site-article_hero-content-inner">
              <h2 className="xt-h1">
                ...
                {page.post.frontmatter.category ? (
                  <div
                    className={`inline-block align-middle rounded${classes.badgeRadius()} ${classes.badgeSm()} text-black font-semibold leading-snug tracking-wider uppercase border-primary-100 bg-primary-100 -mt-4 ml-2`}>
                    {page.post.frontmatter.category}
                  </div>
                ) : null}
                {page.post.frontmatter.tags
                  ? page.post.frontmatter.tags.map((tag, z) => {
                      return (
                        <div
                          key={z}
                          className={`inline-block align-middle rounded${classes.badgeRadius()} ${classes.badgeSm()} text-white font-semibold leading-snug tracking-wider uppercase border-primary-500 bg-primary-500 -mt-4 ml-2`}>
                          {tag}
                        </div>
                      )
                    })
