...
> Direction needs [multiple mode](/xtendui/components/overlay#usage-multiple) to work.
...
> Queue needs [multiple mode](/xtendui/components/overlay#usage-multiple) to work.
