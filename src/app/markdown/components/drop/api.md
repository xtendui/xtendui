...
Access properties by getting [self object](/xtendui/components/drop/api/#util).
...
Call methods by getting [self object](/xtendui/components/drop/api/#util).
...
<demo>
  <div class="docs_demo_item" data-iframe="xtendui/demos/components/drop/api">
  </div>
</demo>
