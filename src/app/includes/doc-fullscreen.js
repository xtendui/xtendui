...
function DocFullscreen() {
  return (
    <>
      <div id="docs_open-full-trigger"></div>
      <div id="docs_open-full" className="off:hidden out:pointer-events-none" aria-label="Fullscreen Demo">
        <div>
          <button
            type="button"
        ...
        <div className="xt-card-content" id="docs_open-full-content"></div>
      </div>
    </>
  )
}
