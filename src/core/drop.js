...
Drop.optionsDefault = {
  // element
  elements: ':scope > a, :scope > button, .xt-drop-item',
  targets: ':scope > .xt-drop, .xt-drop-item > .xt-drop',
  // class
  class: 'in in-drop',
  // quantity
  min: 0,
  ...
  zIndex: {
    targets: {
      start: 200, // theme.zIndex.drop same as Drop options.zIndex.targets.start
      factor: -1,
    },
  },
}
