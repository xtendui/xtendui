...
Tooltip.optionsDefault = {
  // element
  elements: ':scope > a, :scope > button, .xt-tooltip-item',
  targets: ':scope > .xt-tooltip, .xt-tooltip-item > .xt-tooltip',
  // class
  class: 'in in-tooltip',
  classSkip: {
    elements: true,
  ...
  zIndex: {
    targets: {
      start: 200, // theme.zIndex.tooltip same as Tooltip options.zIndex.targets.start
      factor: -1,
    },
  },
}
