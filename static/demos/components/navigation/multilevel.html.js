...
const html = /* HTML */ `
  <div class="demo--multilevel">
    ...
    >
      <nav
        class="xt-toggle xt-toggle-absolute transform ease-out duration-500 -translate-x-10 opacity-0 xt-active:ease-out xt-active:delay-200 xt-active:translate-x-0 xt-active:opacity-100"
