...
const html = /* HTML */ `
  <div class="demo--tooltip-swap-toggle">
    ...
    <div class="xt-tooltip off:hidden out:pointer-events-none p-2 group" id="tooltip--swap-toggle">
      <div
    ...
    <div class="xt-tooltip off:hidden out:pointer-events-none p-2 group *** hidden ***" id="tooltip--swap-toggle-swap">
      <div
        class="relative ${classes.tooltipMd()} ${classes.tooltipRadius()} shadow-tooltip ${classes.cardBlack()} transition duration-300 opacity-0 translate-y-2 group-in:opacity-100 group-in:translate-y-0"
      >
        Toggled!
