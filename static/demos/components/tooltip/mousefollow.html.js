...
const html = /* HTML */ `
  <div>
    <div
      data-xt-tooltip="{ elements: '[data-xt-tooltip-element]', targets: '[data-xt-tooltip-target]', duration: 300, popperjs: false }"
      data-xt-mousefollow
    >
      <button
        type="button"
      ...
      <div class="*** xt-mousefollow fixed *** xt-tooltip p-2 group" data-xt-tooltip-target data-xt-mousefollow-target>
        <div
