    ...
    <div class="xt-list xt-list-3 items-center">
      ...
      >
        ...
        <div class="xt-tooltip p-2 group" data-xt-duration="100">
          <div
            class="relative ${classes.tooltipMd()} ${classes.tooltipRadius()} shadow-tooltip ${classes.cardBlack()} *** transition duration-500 opacity-0 translate-y-4 group-in:opacity-100 group-in:translate-y-0 ***"
          >
