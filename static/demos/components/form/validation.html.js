    ...
    <form class="text-sm">
      <div class="xt-row xt-row-x-6 xt-row-y-4">
        <div class="w-full">
          ...
          <input
            type="text"
            class="${classes.input()} rounded-md ${classes.inputDefault()} input--constrains"
        ...
        <div class="w-full">
          ...
          <input type="file" class="${classes.input()} rounded-md ${classes.inputDefault()}" aria-label="File" required />
        </div>
        ...
        <div class="w-full">
          ...
          <select class="${classes.input()} xt-select rounded-md ${classes.inputDefault()}" aria-label="Select" required>
