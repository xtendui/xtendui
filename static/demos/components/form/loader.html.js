...
const html = /* HTML */ `
  <div class="demo--form-loader">
    <script type="text/x-template" data-js-loader-template>
      <div class="xt-loader absolute z-above inset-0 rounded-inherit overflow-hidden bg-black bg-opacity-30">
        <div class="xt-spinner absolute inset-0 m-auto w-6 h-6">
    ...
    <form class="text-sm mt-12">
      <div class="xt-row xt-row-x-6 xt-row-y-4">
        ...
        <div class="w-full">
          <button
            type="submit"
            class="xt-button ${classes.buttonMd()} ${classes.buttonRadius()} ${classes.buttonDefault()} *** xt-loading-white ***"
          >
            submit
          </button>
        </div>
