...
const html = /* HTML */ `
  <div class="demo--overlay-animation-css">
    <div
      ...
      data-xt-overlay="{ elements: '[data-xt-overlay-element]', targets: '[data-xt-overlay-target]', appendTo: '.demo--overlay-animation-css, .demo--overlay-animation-css-react', duration: 500 }"
    >
      <button
        type="button"
