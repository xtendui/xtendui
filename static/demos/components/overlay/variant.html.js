  ...
  <div>
    <div class="xt-list xt-list-3 items-center">
      ...
      <div data-xt-overlay>
        ...
        <div class="xt-overlay" data-xt-overlay-target>
          ...
          <div class="xt-overlay-container max-w-3xl">
            <div class="xt-overlay-inner">
              <div
                class="xt-card rounded${classes.overlayRadius()} *** ${classes.overlayShadow()} ${classes.textInverse()} ${classes.cardPrimary()} ***">
                <button
                  type="button"
                  class="xt-button xt-dismiss absolute z-above top-0 right-0 p-5 text-2xl"
                  aria-label="Close">
      ...
      <div data-xt-overlay>
        ...
        <div class="xt-overlay" data-xt-overlay-target>
          <div class="*** xt-backdrop z-below bg-gray-800 opacity-0 ***"></div>
          <div class="xt-overlay-container max-w-3xl">
            <div class="xt-overlay-inner">
              <div
                class="xt-card rounded${classes.overlayRadius()} *** ${classes.overlayShadow()} ${classes.textDefault()} ${classes.cardWhite()} ***">
