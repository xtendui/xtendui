...
const html = /* HTML */ `
  <div class="demo--jumptocontent">
    <div
      class="jumptocontent xt-toggle fixed z-above left-0 py-4 w-full flex justify-center transform transition opacity-0 -translate-y-4 xt-active:opacity-100 xt-active:translate-y-0"
    >
