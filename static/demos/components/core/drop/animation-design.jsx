          ...
          <div data-xt-drop>
            ...
            <div className="xt-drop p-4 group" data-xt-duration="500">
              <div className="xt-drop-inner">
                <div
                  className="xt-design rounded-md shadow-drop bg-white transform transition ease-out duration-500 opacity-0 -translate-x-4 group-active:opacity-100 group-active:translate-x-0"
                ></div>
