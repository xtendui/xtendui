          ...
          <div data-xt-drop>
            ...
            <div className="xt-drop p-4">
              <div className="xt-card w-64 rounded-md shadow-drop text-black xt-links-default bg-white">
                <button type="button" className="xt-button xt-dismiss absolute top-0 right-0 p-5 text-lg" aria-label="Close">
          ...
          <div data-xt-drop>
            ...
            <div className="xt-drop p-4">
              <div className="xt-card w-96 rounded-md shadow-drop text-black xt-links-default bg-white">
                <button type="button" className="xt-button xt-dismiss absolute top-0 right-0 p-5 text-2xl" aria-label="Close">
                  <svg xmlns="http://www.w3.org/2000/svg" className="xt-icon" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                </button>
