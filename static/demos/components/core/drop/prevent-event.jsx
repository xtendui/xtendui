    ...
    return (
      <div ref={this.ref}>
        <div data-xt-drop="{ preventEvent: true }">
          <a href="#drop-with-link-0" className="xt-button text-xs py-2 px-3.5 rounded-md text-white font-sans font-semibold leading-snug tracking-wider uppercase bg-primary-500 hover:bg-primary-600 active:bg-primary-700 transition">
            drop
          </a>
