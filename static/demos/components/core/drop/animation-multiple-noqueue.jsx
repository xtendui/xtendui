        ...
        <div className="xt-list xt-list-3 items-center" data-xt-drop="{ queue: false }">
          <div className="xt-drop-item">
            ...
            <div className="xt-drop p-4 group" data-xt-duration="500">
              <div
                className="xt-card w-64 py-3.5 rounded-md shadow-drop text-black xt-links-default bg-white transform transition ease-out duration-500 opacity-0 -translate-x-4 group-active:opacity-100 group-active:translate-x-0"
              >
          ...
          <div className="xt-drop-item">
            ...
            <div className="xt-drop p-4 group" data-xt-duration="500">
              <div
                className="xt-card w-80 rounded-md shadow-drop text-black xt-links-default bg-white transform transition ease-out duration-500 opacity-0 -translate-x-4 group-active:opacity-100 group-active:translate-x-0"
              >
