...
class Demo extends React.Component {
  ...
  render() {
    return (
      <div ref={this.ref}>
        <div className="xt-list xt-list-3 items-center" data-xt-toggle="{ matches: { '(min-width: 768px)': { max: 2 } } }">
          ...
          <div className="xt-card xt-toggle rounded-md text-sm p-6 text-black xt-links-default bg-gray-200 in-toggle">Target 1</div>
        </div>
      </div>
    )
  }
