        ...
        <div className="xt-list xt-list-3 items-center" data-xt-toggle>
          ...
          <div className="xt-card xt-toggle group" data-xt-duration="500">
            <div className="xt-toggle-inner">
              <div
                className="xt-design rounded-md bg-gray-200 transform transition ease-out duration-300 opacity-0 -translate-x-4 group-active:opacity-100 group-active:translate-x-0"
              ></div>
              <div
                className="relative text-sm p-6 text-black xt-links-default transition ease-out duration-300 opacity-0 group-active:opacity-100"
              >
                Target 0
              </div>
            </div>
