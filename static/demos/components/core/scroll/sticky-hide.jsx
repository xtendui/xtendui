...
class Demo extends React.Component {
  ...
  render() {
    return (
      <div ref={this.ref}>
        <div className="demo--sticky-hide-top xt-sticky">
          <div className="demo--sticky-hide-content">
            <div className="xt-card text-sm py-6 px-7 text-white xt-links-inverse bg-primary-500 demo--sticky-hide-top-main">
              <div className="xt-h4">Top</div>
            </div>
            <div className="xt-card text-sm py-6 px-7 text-black xt-links-default bg-gray-200 demo--sticky-hide-top-sub">
