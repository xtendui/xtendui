      ...
      <div ref={this.ref}>
        <div data-xt-tooltip="{ popperjs: false }" data-xt-mousefollow>
          ...
          <div className="xt-tooltip p-2 group xt-mousefollow" data-xt-duration="300">
            <div
              className="relative text-xs py-2 px-3.5 rounded-md shadow-tooltip font-semibold text-white xt-links-inverse bg-black -mt-1 ml-4 pointer-events-none transform transition duration-300 ease-in-out-quint opacity-0 translate-x-4 group-active:opacity-100 group-active:translate-x-0"
            >
