...
class Demo extends React.Component {
  ...
  render() {
    return (
      <div ref={this.ref}>
        <div data-xt-overlay>
          <button type="button" className="xt-button text-xs py-2 px-3.5 rounded-md text-white font-sans font-semibold leading-snug tracking-wider uppercase bg-primary-500 hover:bg-primary-600 active:bg-primary-700 transition">list</button>
                ...
                <div className="xt-card rounded-md shadow-overlay text-black xt-links-default bg-white">
                  ...
                  <div className="text-base py-8 px-9">
                    <div className="xt-list xt-list-6 md:flex-nowrap items-baseline">
                      ...
                      <div className="self-end justify-self-end"><svg xmlns="http://www.w3.org/2000/svg" className="xt-icon text-3xl" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg></div>
                    </div>
                  </div>
                </div>
              </div>
