...
class Demo extends React.Component {
  ...
  render() {
    return (
      <div ref={this.ref}>
        <div className="demo--overlay-disable" data-xt-overlay="{ matches: { '(min-width: 768px)': { disabled: true } } }">
                          ...
                          <div className="xt-overlay-inner">
                            <div className="xt-card rounded-md shadow-overlay text-black xt-links-default bg-white">
                              ...
                              <div className="text-base py-8 px-9">
                                ...
                                <p>
                                  Morbi sodales, dolor a iaculis ornare, velit justo lacinia erat, pretium sollicitudin dui
                                  sem id justo.
                                </p>
                                <p>
