...
class Demo extends React.Component {
  render() {
    return (
      <div ref={this.ref}>
        <div className="xt-list xt-list-3 items-center justify-center demo--overlay-class-html">
                              ...
                              <div className="xt-card rounded-md shadow-overlay text-black xt-links-default bg-white">
                                ...
                                <div className="text-base py-8 px-9">
                                  ...
                                  <p>
                                    ...
                                    mollis, dui felis dictum turpis, a auctor est odio ac diam. Sed mauris augue,
                                    sagittis vitae magna eget, vehicula scelerisque elit.
                                  </p>
                                  <p>
                                    Morbi sodales, dolor a iaculis ornare, velit justo lacinia erat, pretium
                                    sollicitudin dui sem id justo.
                                  </p>
                                  <p>
