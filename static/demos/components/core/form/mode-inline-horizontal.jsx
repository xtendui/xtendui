        ...
        <form className="text-sm">
          <div className="xt-row xt-row-x-6 xt-row-y-4">
            <div className="w-full md:w-auto">
              <div className="xt-row xt-row-x-6 xt-row-y-4">
                <div className="w-full md:w-auto md:self-center">
                  <label className="xt-label whitespace-nowrap text-black text-opacity-75 font-semibold"> Lorem ipsum </label>
                </div>
            ...
            <div className="w-full md:w-auto">
              <div className="xt-row xt-row-x-6 xt-row-y-4">
                <div className="w-full md:w-auto md:self-center">
                  <label className="xt-label whitespace-nowrap text-black text-opacity-75 font-semibold"> Dolor sit amet </label>
                </div>
            ...
            <div className="w-full">
              <div className="xt-row xt-row-x-6 xt-row-y-4">
                <div className="w-full md:w-auto md:self-baseline">
                  <label className="xt-label whitespace-nowrap text-black text-opacity-75 font-semibold"> Checkbox </label>
                </div>
