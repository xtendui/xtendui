        ...
        <form className="text-sm">
          <div className="xt-row xt-row-x-6 xt-row-y-4">
            <div className="w-full">
              ...
              <input type="text" className="xt-input py-2.5 text-black placeholder-black placeholder-opacity-50 border-b-2 border-gray-200 bg-transparent focus:border-gray-300 transition" aria-label="Input" placeholder="Input" />
            </div>
            ...
            <div className="w-full">
              ...
              <input type="file" className="xt-input py-2.5 text-black placeholder-black placeholder-opacity-50 border-b-2 border-gray-200 bg-transparent focus:border-gray-300 transition" aria-label="File" />
            </div>
            ...
            <div className="w-full">
              ...
              <select className="xt-input xt-select py-2.5 text-black placeholder-black placeholder-opacity-50 border-b-2 border-gray-200 bg-transparent focus:border-gray-300 transition" aria-label="Select">
            ...
            <div className="w-full">
              ...
              <select className="xt-input xt-select py-2.5 text-black placeholder-black placeholder-opacity-50 border-b-2 border-gray-200 bg-transparent focus:border-gray-300 transition" multiple aria-label="Select multiple">
