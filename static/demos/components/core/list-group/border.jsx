      ...
      <div ref={this.ref}>
        <form className="text-sm">
          <div className="xt-list flex-nowrap">
            ...
            <button
              type="button"
              className="xt-button text-xs py-2 px-3.5 rounded-r-md border border-l-0 border-gray-500 text-white font-sans font-semibold leading-snug tracking-wider uppercase bg-primary-500 hover:bg-primary-600 active:bg-primary-700 transition"
            >
              Lorem ipsum
            </button>
          </div>
