      ...
      <div ref={this.ref}>
        <form className="text-sm">
          <button type="button" className="xt-list flex-col group">
            <div className="xt-button text-xs py-2 px-3.5 rounded-t-md text-white font-sans font-semibold leading-snug tracking-wider uppercase bg-primary-500 hover:bg-primary-600 group-hover:bg-primary-600 active:bg-primary-700 group-active:bg-primary-700">Search</div>
