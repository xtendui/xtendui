...
const html = /* HTML */ `
  <div>
    <div class="${classes.hBlock()} rounded-md text-black bg-gray-200 text-center">Button small</div>
    ...
    <div class="${classes.hBlock()} rounded-md text-black bg-gray-200 text-center">Button medium</div>
    ...
    <div class="${classes.hBlock()} rounded-md text-black bg-gray-200 text-center">Button large</div>
