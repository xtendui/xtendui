...
const html = /* HTML */ `
  <div>
    ...
    <div class="*** xt-drop off:hidden out:pointer-events-none *** p-4" id="drop--unique-1">
    ...
    <div class="*** xt-drop off:hidden out:pointer-events-none *** p-4" id="drop--unique-2" data-xt-position="right-end">
