    ...
    <div class="xt-slider">
      <div class="p-4 md:p-6 lg:p-8">
        <div class="xt-slides xt-row xt-row-4">
          ...
          <div class="xt-slide w-6/12 sm:w-4/12 ${classes.slide()}" data-xt-hash="demo--slider-hash-2">
            <div class="xt-card rounded-md ${classes.cardSlide()}">
          ...
          <div class="xt-slide w-6/12 sm:w-4/12 ${classes.slide()}" data-xt-hash="demo--slider-hash-6">
            <div class="xt-card rounded-md ${classes.cardSlide()}">
