  ...
  <div class="demo--slider-hash">
    <div class="xt-slider">
      <div class="xt-slides xt-row xt-row-4">
        <div class="xt-slide w-6/12 sm:w-4/12" data-xt-hash="demo--slider-hash-0">
          <div class="xt-card rounded-md ${classes.cardSlide()}">
            <div class="xt-h4">1</div>
          </div>
        </div>

        <div class="xt-slide w-6/12 sm:w-4/12" data-xt-hash="demo--slider-hash-1">
          <div class="xt-card rounded-md ${classes.cardSlide()}">
        ...
        <div class="xt-slide w-7/12 sm:w-6/12 on" data-xt-hash="demo--slider-hash-3">
          <div class="xt-card rounded-md ${classes.cardSlide()}">
            <div class="xt-h4">4</div>
          </div>
        </div>

        <div class="xt-slide w-7/12 sm:w-6/12" data-xt-hash="demo--slider-hash-4">
          <div class="xt-card rounded-md ${classes.cardSlide()}">
