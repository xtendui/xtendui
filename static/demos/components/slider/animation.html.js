...
const html = /* HTML */ `
  <div class="demo--slider-usage-relative">
    <div class="xt-slider">
      <div class="p-4 md:p-6 lg:p-8">
        <div class="xt-slides xt-row xt-row-4">
          <div class="xt-slide w-6/12 sm:w-4/12 md:w-3/12 ${classes.slide()}">
            <div
              class="xt-card ${classes.cardRadius()} text-base p-8 text-center text-black xt-links-default bg-gray-200 border-2 border-transparent *** transition group-in:bg-primary-500 group-in:text-white ***"
            >
