  ...
  <div class="demo--slider-navsides">
    <div class="xt-slider">
      <div class="*** slider-navs-container inline-block w-full relative ***">
        ...
        <button
          type="button"
          class="*** absolute z-content top-0 left-0 h-full px-6 group transition duration-300 ***"
          data-xt-nav="-1"
          aria-label="Previous slide"
        >
          <div class="xt-button text-xl w-10 h-10 rounded-full ${classes.buttonPrimaryGroup()} group-hover:scale-125">
        ...
        <button
          type="button"
          class="*** absolute z-content top-0 right-0 h-full px-6 group transition duration-300 ***"
          data-xt-nav="1"
