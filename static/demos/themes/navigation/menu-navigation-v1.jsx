                    ...
                    <div className="xt-drop-content">
                      <div className="pt-16 pb-24 text-white xt-links-inverse">
                        <div className="container">
                          <a
                            href="#"
                            className="xt-button w-full py-4 px-0 font-sans font-medium tracking-normal normal-case"
                          ...
                          <a href="#" className="xt-button xt-link text-lg mt-6 py-2 px-0"> Show all </a>
                        </div>
                      </div>
                    </div>
                  </div>
