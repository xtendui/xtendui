...
const animDesign =
  'overflow-hidden transform transition ease-in-out-quint duration-500 delay-200 opacity-0 translate-y-full group-in:ease-out-quint group-in:delay-0 group-in:opacity-100 group-in:translate-y-0'
const animItem =
  'transform transition ease-in-out-quint duration-500 opacity-0 translate-y-1/4 group-in:ease-out-quint group-in:delay-200 group-in:opacity-100 group-in:translate-y-0'
...
const animDesignLeft =
  'overflow-hidden transform ease-in-out-quint duration-500 delay-200 opacity-0 -translate-x-full group-in:ease-out-quint group-in:delay-0 group-in:opacity-100 group-in:translate-x-0'
const animItemLeft =
  'transform ease-in-out-quint duration-500 opacity-0 -translate-x-1/4 group-in:ease-out-quint group-in:delay-200 group-in:opacity-100 group-in:translate-x-0'
