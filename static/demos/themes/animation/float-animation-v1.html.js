    ...
    <div data-xt-tooltip="{ mouseParent: true, duration: 500 }">
      ...
      <span>
        ...
        <div class="xt-tooltip p-3 *** group ***" data-xt-tooltip-target>
          <div class="*** relative ***">
            <div
              class="*** xt-design *** rounded${classes.tooltipRadius()} ${classes.tooltipShadow()} ${classes.tooltipText()} ${classes.cardBlack()} *** ${designAnim()} ***"></div>
      ...
      <span>
        ...
        <div class="xt-tooltip p-3 *** group ***" data-xt-tooltip-target>
          <div class="*** relative ***">
            <div
              class="*** xt-design *** rounded${classes.tooltipRadius()} ${classes.tooltipShadow()} ${classes.cardWhite()} *** ${designAnim()} ***"></div>
            <div class="xt-card w-80 ${classes.textDefault()}">
              <div
        ...
        <div aria-label="Modal" class="xt-overlay *** group ***" data-xt-overlay-target>
          ...
          <div class="xt-overlay-container max-w-5xl">
            <div class="xt-overlay-inner">
              <div
                class="*** xt-design *** rounded${classes.overlayRadius()} ${classes.overlayShadow()} ${classes.cardWhite()} *** ${designAnim()} ***"></div>
