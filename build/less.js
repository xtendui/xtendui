...
let lessCore = ''
const lessCoreGlob = new glob.Glob('src/core/**/*.less', { ignore: ['**/_*.less'] }, function(er, files) {
...
let lessAddons = ''
const lessAddonsGlob = new glob.Glob('src/addons/**/*.less', { ignore: ['**/_*.less'] }, function(er, files) {
  for (const file of files) {
...
let lessExtensions = ''
const lessExtensionsGlob = new glob.Glob('src/extensions/**/*.less', { ignore: ['**/_*.less'] }, function(er, files) {
  for (const file of files) {
...
let lessDemos = ''
const lessDemosGlob = new glob.Glob('src/demos/**/*.less', { ignore: ['**/_*.less'] }, function(er, files) {
  for (const file of files) {
