  ...
  it('TEST grouping and activation.', function () {
    cy.get(container)
      ...
      .then(() => {
        ...
        expect(self.targets[5].classList.contains('on')).to.equal(false)
        expect(self.targets[6].classList.contains('on')).to.equal(false)
        expect(container.querySelector('[data-xt-slider-dragger]').style.transform).to.equal('translateX(-159px)')
      })
  })
})
  ...
  it('TEST grouping and activation.', function () {
    cy.get(container)
      ...
      .then(() => {
        ...
        expect(self.targets[5].classList.contains('on')).to.equal(false)
        expect(self.targets[6].classList.contains('on')).to.equal(false)
        expect(container.querySelector('[data-xt-slider-dragger]').style.transform).to.equal('translateX(-191px)')
      })
  })
})
  ...
  it('TEST grouping and activation.', function () {
    cy.get(container)
      ...
      .then(() => {
        ...
        expect(self.targets[5].classList.contains('on')).to.equal(false)
        expect(self.targets[6].classList.contains('on')).to.equal(false)
        expect(container.querySelector('[data-xt-slider-dragger]').style.transform).to.equal('translateX(-699px)')
      })
  })
})
  ...
  it('TEST grouping and activation.', function () {
    cy.get(container)
      ...
      .then(() => {
        ...
        expect(self.targets[5].classList.contains('on')).to.equal(false)
        expect(self.targets[6].classList.contains('on')).to.equal(false)
        expect(container.querySelector('[data-xt-slider-dragger]').style.transform).to.equal('translateX(286px)')
      })
      .get(self.elements[1])
      .click()
      .then(() => {
        ...
        expect(self.targets[5].classList.contains('on')).to.equal(false)
        expect(self.targets[6].classList.contains('on')).to.equal(false)
        expect(container.querySelector('[data-xt-slider-dragger]').style.transform).to.equal('translateX(95px)')
      })
  })
})
  ...
  it('TEST grouping and activation.', function () {
    cy.get(container)
      ...
      .then(() => {
        ...
        expect(self.targets[5].classList.contains('on')).to.equal(false)
        expect(self.targets[6].classList.contains('on')).to.equal(false)
        expect(container.querySelector('[data-xt-slider-dragger]').style.transform).to.equal('translateX(572px)')
      })
      .get(self.elements[1])
      .click()
      .then(() => {
        ...
        expect(self.targets[5].classList.contains('on')).to.equal(false)
        expect(self.targets[6].classList.contains('on')).to.equal(false)
        expect(container.querySelector('[data-xt-slider-dragger]').style.transform).to.equal('translateX(381px)')
      })
  })
})
  ...
  it('TEST grouping and activation, wrap position, performance slider.', function () {
    cy.get(container)
      ...
      .then(() => {
        ...
        expect(self.targets[5].style.transform).to.equal('translateX(-2162px)')
        expect(self.targets[6].style.transform).to.equal('translateX(-2162px)')
        ...
        expect(self.targets[4].style.width).to.equal('318px')
        ...
        expect(self.targets[3].style.height).to.equal('117px')
        expect(self.targets[4].style.height).to.equal('117px')
      ...
      .then(() => {
        ...
        expect(self.targets[6].classList.contains('on')).to.equal(false)
        expect(container.querySelector('[data-xt-slider-dragger]').style.transform).to.equal('translateX(-1239px)')
        expect(self.targets[0].style.transform).to.equal('')
        expect(self.targets[1].style.transform).to.equal('')
        expect(self.targets[2].style.transform).to.equal('')
        expect(self.targets[3].style.transform).to.equal('')
        expect(self.targets[4].style.transform).to.equal('')
        expect(self.targets[5].style.transform).to.equal('translateX(-0.5px)')
        expect(self.targets[6].style.transform).to.equal('translateX(-0.5px)')
        expect(self.targets[0].style.width).to.equal('191px')
        expect(self.targets[1].style.width).to.equal('191px')
        expect(self.targets[2].style.width).to.equal('318px')
        ...
        expect(self.targets[0].style.height).to.equal('117px')
        expect(self.targets[1].style.height).to.equal('117px')
        expect(self.targets[2].style.height).to.equal('117px')
  ...
  it('TEST grouping and activation, wrap position.', function () {
    cy.get(container)
      ...
      .then(() => {
        ...
        expect(self.targets[2].style.transform).to.equal('')
        expect(self.targets[3].style.transform).to.equal('')
        expect(self.targets[4].style.transform).to.equal('translateX(-2162px)')
        expect(self.targets[5].style.transform).to.equal('translateX(-2162px)')
        expect(self.targets[6].style.transform).to.equal('translateX(-2162px)')
      })
      .get(self.elements[6])
      ...
      .then(() => {
        ...
        expect(self.targets[1].style.transform).to.equal('')
        expect(self.targets[2].style.transform).to.equal('')
        expect(self.targets[3].style.transform).to.equal('translateX(-2162px)')
        expect(self.targets[4].style.transform).to.equal('translateX(-2162px)')
        expect(self.targets[5].style.transform).to.equal('translateX(-2162px)')
        expect(self.targets[6].style.transform).to.equal('translateX(-2162px)')
      })
  ...
  it('TEST group responsive.', function () {
    cy.get(container)
      ...
      .then(() => {
        ...
        expect(self.targets[4].style.transform).to.equal('')
        expect(self.targets[5].style.transform).to.equal('')
        expect(self.targets[6].style.transform).to.equal('translateX(-2162.5px)')
      })
      .viewport('iphone-6')
      ...
      .then(() => {
        ...
        expect(self.targets[3].style.transform).to.equal('')
        expect(self.targets[4].style.transform).to.equal('')
        expect(self.targets[5].style.transform).to.equal('translateX(-1291px)')
        expect(self.targets[6].style.transform).to.equal('translateX(-1291px)')
      })
      .viewport('macbook-13')
  ...
  it('TEST group.', function () {
    cy.get(container)
      ...
      .then(() => {
        ...
        expect(self.targets[5].classList.contains('on')).to.equal(false)
        expect(self.targets[6].classList.contains('on')).to.equal(true)
        expect(container.querySelector('[data-xt-slider-dragger]').style.transform).to.equal('translateX(477px)')
        expect(self.targets[0].style.transform).to.equal('')
        expect(self.targets[1].style.transform).to.equal('')
        expect(self.targets[2].style.transform).to.equal('')
        expect(self.targets[3].style.transform).to.equal('')
  ...
  it('TEST deactivation and position, activation on resize.', function () {
    cy.get(container)
      ...
      .then(() => {
        ...
        expect(self.targets[1].classList.contains('on')).to.equal(true)
        expect(self.targets[2].classList.contains('on')).to.equal(true)
        expect(container.querySelector('[data-xt-slider-dragger]').style.transform).to.equal('translateX(190px)')
      })
      .viewport('iphone-6')
      .get(container)
  ...
  it('TEST activation and drag activation.', function () {
    cy.get(container)
      ...
      .then(() => {
        ...
        expect(self.targets[5].classList.contains('on')).to.equal(false)
        expect(self.targets[6].classList.contains('on')).to.equal(false)
        expect(container.querySelector('[data-xt-slider-dragger]').style.transform).to.equal('translate(-699px, 0px)')
      })
      .get(self.elements[1])
      .click()
      .wait(750) // after animation
      .then(() => {
        ...
        expect(self.targets[5].classList.contains('on')).to.equal(false)
        expect(self.targets[6].classList.contains('on')).to.equal(false)
        expect(container.querySelector('[data-xt-slider-dragger]').style.transform).to.equal('translate(-159px, 0px)')
      })
  })
})
