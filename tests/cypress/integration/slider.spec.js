...
describe('demos/components/slider/wrap-center', function () {
  ...
  it('TEST grouping and activation, wrap position, performance slider.', function () {
    cy.get(container)
      .should('have.attr', 'data-xt-slider-init', '') // racecondition
      .frameDouble() // racecondition perf
      .then(() => {
        expect(self.targets[0].classList.contains('on')).to.equal(true)
        expect(self.targets[1].classList.contains('on')).to.equal(true)
        expect(self.targets[2].classList.contains('on')).to.equal(false)
        ...
        expect(self.targets[4].style.width).to.equal('320px')
        ...
        expect(self.targets[0].children[0].style.display).to.equal('')
        expect(self.targets[1].children[0].style.display).to.equal('')
        expect(self.targets[2].children[0].style.display).to.equal('')
        expect(self.targets[3].children[0].style.display).to.equal('none')
      ...
      .then(() => {
        ...
        expect(self.targets[6].classList.contains('on')).to.equal(false)
        expect(container.querySelector('[data-xt-slider-dragger]').style.transform).to.equal('translateX(928px)')
        expect(self.targets[0].style.transform).to.equal('')
        expect(self.targets[1].style.transform).to.equal('')
        expect(self.targets[2].style.transform).to.equal('')
        ...
        expect(self.targets[0].children[0].style.display).to.equal('')
        expect(self.targets[1].children[0].style.display).to.equal('')
        expect(self.targets[2].children[0].style.display).to.equal('none')
        expect(self.targets[3].children[0].style.display).to.equal('none')
        expect(self.targets[4].children[0].style.display).to.equal('')
        expect(self.targets[5].children[0].style.display).to.equal('')
        expect(self.targets[6].children[0].style.display).to.equal('')
      })
  })
})
