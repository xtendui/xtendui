  ...
  it.only('TEST grouping and activation, no wrap, performance slider.', function () {
    cy.get(container)
      ...
      .then(() => {
        ...
        expect(self.targets[4].style.width).to.equal('384px')
        ...
        expect(self.targets[3].children[0].style.display).to.equal('')
      ...
      .then(() => {
        ...
        expect(self.targets[3].style.height).to.equal('')
        expect(self.targets[4].style.height).to.equal('116.5px')
        expect(self.targets[0].children[0].style.display).to.equal('none')
        expect(self.targets[1].children[0].style.display).to.equal('')
        expect(self.targets[2].children[0].style.display).to.equal('')
        expect(self.targets[3].children[0].style.display).to.equal('')
        expect(self.targets[4].children[0].style.display).to.equal('none')
