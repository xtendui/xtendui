    ...
    <div>
      ...
      <form
        ...
        <div className="xt-row xt-row-x-6 xt-row-y-4">
          ...
          <div className="w-full md:w-auto">
            <div className="xt-list flex-nowrap max-w-sm w-0 overflow-hidden transform ease-out-quint duration-500 -translate-x-4 in:translate-x-0">
      ...
      <div className="xt-list xt-list-3 items-center">
        <div data-xt-drop="{ targetsInner: '.xt-drop-inner', collapseHeight: 'targetsInner' }">
          ...
          <div className="xt-drop p-4 group" data-xt-duration="500">
            <div
              className="xt-drop-inner rounded-md shadow-drop h-0 overflow-hidden transform -translate-y-4 group-in:transition-all group-in:duration-500 group-in:ease-out-quint group-in:translate-y-0 group-out:transition-all group-out:duration-500 group-out:ease-in-out-quint group-out:-translate-y-2"
              data-xt-duration="500">
              <div className="xt-card w-64 py-3.5 rounded-md text-black xt-links-default bg-white">
                <nav className="xt-list flex-col rounded-mdtransform opacity-0 -translate-y-2 group-in:transition group-in:duration-500 group-in:delay-200 group-in:ease-out-quint group-in:opacity-100 group-in:translate-y-0 group-out:transition group-out:duration-300 group-out:ease-in-out-quint group-out:-translate-y-2">
                  <a
                    href="#"
          ...
          <div className="xt-drop p-4 group" data-xt-duration="500">
            <div
              ...
              <div className="xt-card w-64 rounded-md text-black xt-links-default bg-white">
                ...
                <div className="text-sm py-6 px-7 rounded-md transform opacity-0 -translate-y-2 group-in:transition group-in:duration-500 group-in:delay-200 group-in:ease-out-quint group-in:opacity-100 group-in:translate-y-0 group-out:transition group-out:duration-300 group-out:ease-in-out-quint group-out:-translate-y-2">
      ...
      <div className="xt-list xt-list-3 items-center">
        <div data-xt-tooltip="{  targetsInner: '.xt-tooltip-inner', collapseHeight: 'targetsInner' }">
          <div className="xt-tooltip-item">
            ...
            <div className="xt-tooltip p-2 group" data-xt-duration="500">
              <div
                className="xt-tooltip-inner h-0 overflow-hidden transform -translate-y-4 group-in:transition-all group-in:duration-500 group-in:ease-out-quint group-in:translate-y-0 group-out:transition-all group-out:duration-500 group-out:ease-in-out-quint group-out:-translate-y-2"
                data-xt-duration="500">
                <div className="relative text-xs py-2 px-3.5 rounded-md shadow-tooltip font-semibold text-white xt-links-inverse bg-black">
                  <div className="transform opacity-0 -translate-y-2 group-in:transition group-in:duration-500 group-in:delay-200 group-in:ease-out-quint group-in:opacity-100 group-in:translate-y-0 group-out:transition group-out:duration-300 group-out:ease-in-out-quint group-out:-translate-y-2">
        ...
        <div data-xt-tooltip="{  targetsInner: '.xt-tooltip-inner', collapseHeight: 'targetsInner' }">
          <div className="xt-tooltip-item">
            ...
            <div className="xt-tooltip p-2 group" data-xt-duration="500">
              <div
                className="xt-tooltip-inner rounded-md shadow-tooltip text-black bg-white h-0 overflow-hidden transform -translate-y-4 group-in:transition-all group-in:duration-500 group-in:ease-out-quint group-in:translate-y-0 group-out:transition-all group-out:duration-500 group-out:ease-in-out-quint group-out:-translate-y-2"
                data-xt-duration="500">
                <form className="text-sm">
                  <div className="xt-list flex-nowrap max-w-sm transform opacity-0 -translate-y-2 group-in:transition group-in:duration-500 group-in:delay-200 group-in:ease-out-quint group-in:opacity-100 group-in:translate-y-0 group-out:transition group-out:duration-300 group-out:ease-in-out-quint group-out:-translate-y-2">
                    <div className="xt-list-inner flex-auto">
                      <button
                        type="button"
                        className="xt-button text-xs py-2 px-3.5 rounded-l-md text-black font-sans font-semibold leading-snug tracking-wider uppercase bg-gray-200 transition hover:bg-gray-300 active:bg-gray-400 on:bg-gray-400">
        ...
        <div data-xt-overlay="{ targetsInner: '.xt-overlay-inner', collapseHeight: 'targetsInner' }">
          ...
          <div className="xt-overlay group" data-xt-duration="500">
            ...
            <div className="xt-overlay-container p-0">
              ...
              <div
                className="xt-overlay-inner h-0 overflow-hidden transform -translate-y-4 group-in:transition-all group-in:duration-500 group-in:ease-out-quint group-in:translate-y-0 group-out:transition-all group-out:duration-500 group-out:ease-in-out-quint group-out:-translate-y-2"
                data-xt-duration="500">
                <div className="xt-card xt-min-h-screen items-center justify-center text-black xt-links-default bg-white">
                  <div className="xt-media-container bg-gray-600 xt-ratio-100 transform opacity-0 -translate-y-2 group-in:transition group-in:duration-500 group-in:delay-200 group-in:ease-out-quint group-in:opacity-100 group-in:translate-y-0 group-out:transition group-out:duration-300 group-out:ease-in-out-quint group-out:-translate-y-2">
            ...
            <div className="xt-overlay-container p-0 w-screen max-w-md ml-0 mr-auto">
              <div
                ...
                <div className="xt-card xt-min-h-screen text-black xt-links-default bg-white">
                  ...
                  <div className="xt-list bg-primary-500 transform opacity-0 -translate-y-2 group-in:transition group-in:duration-500 group-in:delay-200 group-in:ease-out-quint group-in:opacity-100 group-in:translate-y-0 group-out:transition group-out:duration-300 group-out:ease-in-out-quint group-out:-translate-y-2">
                    <button
                      type="button"
                  ...
                  <div className="xt-media-container bg-gray-600 h-48 transform opacity-0 -translate-y-2 group-in:transition group-in:duration-500 group-in:delay-200 group-in:ease-out-quint group-in:opacity-100 group-in:translate-y-0 group-out:transition group-out:duration-300 group-out:ease-in-out-quint group-out:-translate-y-2">
                    <img className="xt-media object-cover object-center" src="/img.svg" loading="eager" alt="" />
                  </div>
                  <div className="text-base py-8 px-9 transform opacity-0 -translate-y-2 group-in:transition group-in:duration-500 group-in:delay-200 group-in:ease-out-quint group-in:opacity-100 group-in:translate-y-0 group-out:transition group-out:duration-300 group-out:ease-in-out-quint group-out:-translate-y-2">
                  ...
                  <div className="text-sm py-6 px-7 bg-gray-300 mt-auto transform opacity-0 -translate-y-2 group-in:transition group-in:duration-500 group-in:delay-200 group-in:ease-out-quint group-in:opacity-100 group-in:translate-y-0 group-out:transition group-out:duration-300 group-out:ease-in-out-quint group-out:-translate-y-2">
                    <p>
        ...
        <div data-xt-overlay="{ targetsInner: '.xt-overlay-inner', collapseHeight: 'targetsInner' }">
          ...
          <div className="xt-overlay group" data-xt-duration="500">
            ...
            <div className="xt-overlay-container max-w-5xl">
              <div
                className="xt-overlay-inner rounded-md shadow-overlay h-0 overflow-hidden transform -translate-y-4 group-in:transition-all group-in:duration-500 group-in:ease-out-quint group-in:translate-y-0 group-out:transition-all group-out:duration-500 group-out:ease-in-out-quint group-out:-translate-y-2"
                data-xt-duration="500">
                <div className="xt-card rounded-md text-black xt-links-default bg-white">
                  ...
                  <div className="md:xt-card-group rounded-md transform opacity-0 -translate-y-2 group-in:transition group-in:duration-500 group-in:delay-200 group-in:ease-out-quint group-in:opacity-100 group-in:translate-y-0 group-out:transition group-out:duration-300 group-out:ease-in-out-quint group-out:-translate-y-2">
                    ...
                    <div className="md:w-5/12 flex flex-col transform opacity-0 -translate-y-2 group-in:transition group-in:duration-500 group-in:delay-200 group-in:ease-out-quint group-in:opacity-100 group-in:translate-y-0 group-out:transition group-out:duration-300 group-out:ease-in-out-quint group-out:-translate-y-2">
            ...
            <div className="xt-overlay-container max-w-5xl">
              <div
                ...
                <div className="xt-card rounded-md text-black xt-links-default bg-white">
                  ...
                  <div className="text-sm py-6 px-7 rounded-b-md bg-gray-300 transform opacity-0 -translate-y-2 group-in:transition group-in:duration-500 group-in:delay-200 group-in:ease-out-quint group-in:opacity-100 group-in:translate-y-0 group-out:transition group-out:duration-300 group-out:ease-in-out-quint group-out:-translate-y-2">
                    <p>
