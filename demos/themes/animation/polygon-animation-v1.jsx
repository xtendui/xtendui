...
export default function Demo() {
  ...
  return (
    <div className="demo--polygon-animation-v1-react" ref={ref}>
      ...
      <div className="xt-list xt-list-3 items-center">
        <div data-xt-overlay="{ appendTo: '.demo--polygon-animation-v1, .demo--polygon-animation-v1-react', duration: 650 }">
          <button
            type="button"
            className="xt-button py-2.5 px-3.5 text-sm rounded-md font-medium leading-snug tracking-wider uppercase text-white xt-links-inverse bg-primary-500 border-transparent border"
