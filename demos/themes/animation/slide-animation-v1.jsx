      ...
      <div className="xt-list xt-list-3 items-center">
        <div data-xt-drop="{ position: 'auto-end', duration: 500 }">
          ...
          <div className="xt-drop p-3 *** group ***" data-xt-drop-target>
            <div className="xt-card w-60 rounded-md shadow-lg text-white xt-links-inverse bg-primary-500 *** overflow-hidden opacity-0 translate-y-full group-in:duration-300 group-in:ease-out-cubic group-in:opacity-100 group-in:translate-y-0 group-out:transition group-out:duration-300 group-out:delay-100 group-out:ease-in-out-cubic group-out:translate-y-2/4 ***">
      ...
      <div data-xt-tooltip="{ duration: 500 }">
        ...
        <span data-xt-tooltip-element>
          ...
          <div className="xt-tooltip p-3 *** group ***" data-xt-tooltip-target>
            <div className="xt-card w-80 rounded-md shadow-md text-white xt-links-inverse font-medium bg-black *** overflow-hidden opacity-0 translate-y-full group-in:duration-300 group-in:ease-out-cubic group-in:opacity-100 group-in:translate-y-0 group-out:transition group-out:duration-300 group-out:delay-100 group-out:ease-in-out-cubic group-out:translate-y-2/4 ***">
        ...
        <div data-xt-overlay="{ duration: 500 }">
          ...
          <div className="xt-overlay *** group ***" data-xt-overlay-target>
            ...
            <div className="xt-overlay-container *** p-0 *** *** w-screen max-w-md ml-0 mr-auto ***">
              <div className="xt-overlay-inner">
                <div className="xt-card *** xt-min-h-screen *** shadow-xl text-white xt-links-inverse bg-black *** overflow-hidden opacity-0 translate-y-full group-in:duration-300 group-in:ease-out-cubic group-in:opacity-100 group-in:translate-y-0 group-out:transition group-out:duration-300 group-out:delay-100 group-out:ease-in-out-cubic group-out:translate-y-2/4 ***">
