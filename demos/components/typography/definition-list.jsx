...
export default function Demo() {
  return (
    <div>
      <dl>
        <dt className="font-bold">Lorem ipsum dolor sit amet, consectetur adipiscing elit</dt>
        <dd className="my-3 xt-mb-auto">
      ...
      <dl className="flex flex-wrap">
        <dt className="w-4/12 lg:w-3/12 xl:w-2/12 mb-3 xt-mb-auto font-bold truncate">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit
        </dt>
        <dd className="w-8/12 lg:w-9/12 xl:w-10/12 mb-3 xt-mb-auto pl-3">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam in laoreet tellus, nec commodo massa. Aenean ut
          ex at ex pellentesque efficitur.
        </dd>
        <dt className="w-4/12 lg:w-3/12 xl:w-2/12 mb-3 xt-mb-auto font-bold">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit
        </dt>
        <dd className="w-8/12 lg:w-9/12 xl:w-10/12 mb-3 xt-mb-auto pl-3">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam in laoreet tellus, nec commodo massa. Aenean ut
