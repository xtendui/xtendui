  ...
  return (
    <div className="demo--toggle-class-custom-react">
      <div className="xt-list xt-list-3 items-center" data-xt-toggle="{ class: 'on on--toggle-custom-class' }">
        ...
        <button
          type="button"
          className="xt-button py-2 px-3 text-xs rounded-full font-medium leading-snug text-gray-900 bg-gray-100 transition hover:bg-primary-300 hover:bg-opacity-25 active:text-white active:bg-primary-500 on:text-white on:bg-primary-500 on--toggle-custom-class"
          data-xt-toggle-element>
          Toggle 1
        </button>
