  ...
  return (
    <div className="demo--toggle-class-custom-react">
      <div className="xt-list xt-list-3 items-center" data-xt-toggle="{ class: 'on on--toggle-custom-class' }">
        ...
        <button
          type="button"
          className="xt-button rounded-full py-2.5 px-3.5 text-xs text-black font-semibold bg-gray-200 transition hover:bg-gray-300 active:text-white active:bg-primary-500 on:text-white on:bg-primary-500 transition on--toggle-custom-class"
          data-xt-toggle-element>
          Toggle 1
        </button>
