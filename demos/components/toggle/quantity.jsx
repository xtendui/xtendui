...
export default function Demo() {
  return (
    <div className="demo--toggle-quantity-react">
      <div className="xt-list xt-list-3 items-center" data-xt-toggle="{ min: 2, max: 2 }">
        <button
          type="button"
          className="xt-button py-2 px-3 text-xs rounded-full font-medium leading-snug text-gray-900 bg-gray-100 transition hover:bg-primary-300 hover:bg-opacity-25 active:text-white active:bg-primary-500 on:text-white on:bg-primary-500 *** on ***"
