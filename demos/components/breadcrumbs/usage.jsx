  ...
  return (
    <div>
      <nav aria-label="Breadcrumbs" className="*** truncate ***">
        ...
        <span className="inline relative align-baseline before:content-['/'] mx-0.5 text-sm"></span>
        <div className="xt-button *** inline *** py-1.5 px-2 text-2xs rounded-full font-medium leading-snug tracking-wider uppercase transition hover:opacity-75 pointer-events-none">
          Lorem ipsum
        </div>
      </nav>
    </div>
