            ...
            <div className="xt-overlay-container *** p-0 ***">
              <div className="xt-overlay-inner">
                <div className="xt-card shadow-xl text-gray-900 xt-links-default bg-white">
                  <div className="*** xt-card items-center justify-center xt-min-h-screen ***">
                    <button
                      type="button"
                    ...
                    <div className="max-w-3xl">
                      <div className="p-7 sm:p-9 text-base">
                        ...
                        <p>
                          Morbi sodales, dolor a iaculis ornare, velit justo lacinia erat, pretium sollicitudin dui sem
                          id justo.
                        </p>
                        <p>
