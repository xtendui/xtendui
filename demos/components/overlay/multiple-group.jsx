  ...
  return (
    <div>
      <div className="xt-list xt-list-3 items-center" data-xt-overlay>
        ...
        <div className="xt-overlay" data-xt-overlay-target data-xt-group="group0">
        ...
        <div className="xt-overlay" data-xt-overlay-target data-xt-group="group1">
          <div className="xt-backdrop z-below bg-gray-800 opacity-25"></div>
          <div className="xt-overlay-container max-w-3xl">
            <div className="xt-overlay-inner">
              <div className="xt-card rounded-2xl shadow-xl text-gray-900 xt-links-default bg-white">
        ...
        <div className="xt-overlay" data-xt-overlay-target data-xt-group="group2">
          <div className="xt-backdrop z-below bg-gray-800 opacity-25"></div>
          <div className="xt-overlay-container max-w-3xl">
            <div className="xt-overlay-inner">
              <div className="xt-card rounded-2xl shadow-xl text-gray-900 xt-links-default bg-white">
