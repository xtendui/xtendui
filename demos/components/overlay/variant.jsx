    ...
    <div>
      <div className="xt-list xt-list-3 items-center">
        ...
        <div data-xt-overlay>
          ...
          <div className="xt-overlay" data-xt-overlay-target>
            <div className="*** xt-backdrop z-below bg-primary-700 bg-opacity-25 ***"></div>
            <div className="xt-overlay-container max-w-3xl">
              <div className="xt-overlay-inner">
        ...
        <div data-xt-overlay>
          ...
          <div className="xt-overlay" data-xt-overlay-target>
            <div className="*** xt-backdrop z-below bg-black opacity-0 ***"></div>
            <div className="xt-overlay-container max-w-3xl">
              <div className="xt-overlay-inner">
                <div className="xt-card rounded-md *** shadow-overlay text-black xt-links-default bg-white ***">
                  <button
        ...
        <div data-xt-overlay>
          ...
          <div className="xt-overlay" data-xt-overlay-target>
            <div className="*** xt-backdrop z-below bg-black bg-opacity-10 ***"></div>
            <div className="xt-overlay-container max-w-3xl">
              <div className="xt-overlay-inner">
                <div className="xt-card rounded-md *** shadow-overlay text-black xt-links-default bg-white bg-opacity-70 backdrop-filter backdrop-blur ***">
                  <button
                    type="button"
                    className="xt-button xt-dismiss absolute z-above top-0 right-0 p-5 text-2xl"
                    aria-label="Close">
