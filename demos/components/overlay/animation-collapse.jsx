...
export default function demo() {
  return (
    <div>
      <div data-xt-overlay="{ targetsInner: '[data-xt-overlay-inner]', collapseHeight: 'targetsInner', position: 'auto-end', duration: 500 }">
        <button
          type="button"
        ...
        <div className="xt-overlay *** group ***" data-xt-overlay-target>
          ...
          <div className="xt-overlay-container max-w-3xl">
            <div className="xt-overlay-inner *** transition opacity-0 -translate-y-4 group-in:opacity-100 group-in:translate-y-0 group-out:translate-y-4 ***">
              <div
                className="xt-card rounded-2xl shadow-xl text-gray-900 xt-links-default bg-white *** overflow-hidden transition-all ***"
