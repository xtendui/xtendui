    ...
    <div>
      <div className="xt-row">
        <div className="w-full md:w-6/12">
          <button
            type="button"
            className="xt-card rounded-2xl *** transition hover:bg-gray-200 active:bg-gray-300 on:bg-gray-200 ***">
        ...
        <div className="w-full md:w-6/12">
          <button
            type="button"
            className="xt-card rounded-2xl *** transition hover:text-white hover:bg-primary-600 active:text-white active:bg-primary-700 on:text-white on:bg-primary-600 ***">
            <div className="p-7 sm:p-9 text-base">
