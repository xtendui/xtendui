    ...
    <div className="demo--navsides-slider-react" ref={ref}>
      <div className="xt-slider">
        ...
        <nav className="w-full xt-list xt-list-3 pt-4 items-center justify-center" data-xt-slider-pagination>
          <button
            type="button"
            className="xt-button text-2xs py-2 px-3.5 w-5 h-6 rounded-full text-black font-semibold leading-snug tracking-wider uppercase bg-gray-100 hover:bg-gray-200 on:px-5 on:bg-gray-300 transition-all hidden"
