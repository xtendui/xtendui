    ...
    <div className="demo--slider-media-loaded-react" ref={ref}>
      <div className="xt-slider">
        <div className="xt-slides xt-row xt-row-4">
          ...
          <div className="xt-slide">
            <div className="xt-media-container bg-gray-600">
              <img className="xt-media relative" src="https://source.unsplash.com/ruJm3dBXCqw" loading="lazy" alt="" />
              <div className="xt-loader absolute z-above inset-0 rounded-inherit overflow-hidden bg-white bg-opacity-75">
                <div className="xt-spinner absolute inset-0 m-auto w-6 h-6 text-primary-500">
                  <svg viewBox="0 0 240 240" className="absolute" preserveAspectRatio="xMinYMin meet">
                    <circle
          ...
          <div className="xt-slide">
            <div className="xt-media-container bg-gray-600">
              <img className="xt-media relative" src="https://source.unsplash.com/wQLAGv4_OYs" loading="lazy" alt="" />
              <div className="xt-loader absolute z-above inset-0 rounded-inherit overflow-hidden bg-white bg-opacity-75">
                <div className="xt-spinner absolute inset-0 m-auto w-6 h-6 text-primary-500">
                  <svg viewBox="0 0 240 240" className="absolute" preserveAspectRatio="xMinYMin meet">
                    <circle
          ...
          <div className="xt-slide">
            <div className="xt-media-container bg-gray-600">
              <img className="xt-media relative" src="https://source.unsplash.com/OlTjeydUpQw" loading="lazy" alt="" />
              <div className="xt-loader absolute z-above inset-0 rounded-inherit overflow-hidden bg-white bg-opacity-75">
                <div className="xt-spinner absolute inset-0 m-auto w-6 h-6 text-primary-500">
                  <svg viewBox="0 0 240 240" className="absolute" preserveAspectRatio="xMinYMin meet">
                    <circle
          ...
          <div className="xt-slide">
            <div className="xt-media-container bg-gray-600">
              <img className="xt-media relative" src="https://source.unsplash.com/wEL2zPX3jDg" loading="lazy" alt="" />
              <div className="xt-loader absolute z-above inset-0 rounded-inherit overflow-hidden bg-white bg-opacity-75">
                <div className="xt-spinner absolute inset-0 m-auto w-6 h-6 text-primary-500">
                  <svg viewBox="0 0 240 240" className="absolute" preserveAspectRatio="xMinYMin meet">
                    <circle
          ...
          <div className="xt-slide">
            <div className="xt-media-container bg-gray-600">
              <img className="xt-media relative" src="https://source.unsplash.com/Tyg0rVhOTrE" loading="lazy" alt="" />
              <div className="xt-loader absolute z-above inset-0 rounded-inherit overflow-hidden bg-white bg-opacity-75">
                <div className="xt-spinner absolute inset-0 m-auto w-6 h-6 text-primary-500">
                  <svg viewBox="0 0 240 240" className="absolute" preserveAspectRatio="xMinYMin meet">
                    <circle
