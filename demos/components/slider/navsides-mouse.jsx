...
export default function demo() {
  ...
  return (
    <div className="demo--slider-navsides-mouse-react" ref={ref}>
        ...
        <div className="*** slider-navs-container inline-block w-full relative ***">
          ...
          <button
            ...
            <div
              ...
              <div className="xt-button w-8 h-8 md:w-10 md:h-10 text-lg md:text-xl rounded-full text-white font-semibold leading-snug tracking-wider uppercase bg-primary-500 transition group-hover:bg-primary-600 group-active:bg-primary-700 group-on:on:bg-primary-600">
                <svg
