...
export default function component() {
  ...
  return (
    <div className="demo--slider-autoheight-react" ref={ref}>
      <div className="xt-slider">
        <div className="p-4 md:p-6 lg:p-8">
          <div className="xt-slides-autoheight inline-block w-full transition-all duration-300">
            <div className="xt-slides xt-row xt-row-4">
              <div className="xt-slide w-8/12 sm:w-6/12">
                <div className="xt-card rounded-md text-base p-8 text-center text-black xt-links-default bg-gray-200 h-32">
              ...
              <div className="xt-slide w-6/12 sm:w-4/12">
                <div className="xt-card rounded-md text-base p-8 text-center text-black xt-links-default bg-gray-200 h-40">
