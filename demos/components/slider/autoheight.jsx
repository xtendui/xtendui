...
export default function Demo() {
  return (
    <div className="demo--slider-autoheight-react">
      <div className="xt-slider" data-xt-slider="{ autoHeight: '[data-xt-slider-autoheight]' }">
        <div className="p-4 md:p-6 lg:p-8">
          <div className="inline-block overflow-hidden w-full transition-all duration-300" data-xt-slider-autoheight>
            <div
              ...
              <div className="xt-slide w-full group" data-xt-slider-target>
                <div className="xt-card text-gray-900 xt-links-default rounded-md bg-gray-100 border-2 border-transparent transition group-in:border-gray-200 p-8 text-base text-center h-32">
