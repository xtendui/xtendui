    ...
    <div className="demo--slider-autoheight-react" ref={ref}>
      <div className="xt-slider">
        <div className="p-4 md:p-6 lg:p-8">
          <div className="xt-slides-autoheight inline-block overflow-hidden w-full transition-all duration-300">
            <div className="xt-slides xt-row xt-row-4">
              ...
              <div className="xt-slide w-full group">
                <div className="xt-card rounded-md text-base p-8 text-center text-black xt-links-default bg-gray-200 border-2 border-transparent transition group-in:border-gray-400 h-32">
