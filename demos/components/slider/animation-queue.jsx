...
export default function demo() {
  ...
  return (
    <div className="demo--slider-animation-queue-react" ref={ref}>
        ...
        <div className="p-4 md:p-6 lg:p-8">
          <div className="xt-slides xt-row xt-row-4" data-xt-slider-dragger>
            <div className="xt-slide w-6/12 sm:w-4/12 md:w-3/12 group" data-xt-slider-target>
              <div className="xt-card rounded-md p-8 text-base text-center text-black xt-links-default bg-gray-100 border-2 border-transparent group-in:border-gray-200 transition *** transition opacity-0 group-in:opacity-100 ***">
            ...
            <div className="xt-slide w-8/12 sm:w-6/12 md:w-5/12 group *** on ***" data-xt-slider-target>
              <div className="xt-card rounded-md p-8 text-base text-center text-black xt-links-default bg-gray-100 border-2 border-transparent group-in:border-gray-200 transition *** transition opacity-0 group-in:opacity-100 ***">
