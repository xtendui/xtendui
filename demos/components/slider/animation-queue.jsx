...
export default function demo() {
  return (
    <div>
      <div className="xt-slider" data-xt-slider="{ wrap: true, queue: { targets: true }, duration: 500 }">
        <div className="p-4 md:p-6 lg:p-8">
          <div
            ...
            <div className="xt-slide w-6/12 sm:w-4/12 md:w-3/12 group" data-xt-slider-target>
              <div className="xt-card text-gray-900 xt-links-default rounded-md bg-gray-100 border-2 border-transparent transition group-in:border-gray-200 p-8 text-base text-center *** transition opacity-50 group-in:opacity-100 ***">
