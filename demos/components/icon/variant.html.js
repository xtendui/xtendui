...
const html = /* HTML */ `
  <div>
    <div class="${classes.hBlock()} rounded-md text-black bg-gray-200 text-center">Text</div>

    ${classes.iconSearch()}

    <div class="${classes.hBlock()} rounded-md text-black bg-gray-200 text-center">Primary</div>
    ...
    <div class="${classes.hBlock()} rounded-md text-black bg-gray-200 text-center">Black opacity</div>
