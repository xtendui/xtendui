    ...
    <div>
      ...
      <div className="xt-list xt-list-3 items-center">
        <button
          ...
          <svg
            ...
            className="xt-icon text-xs ml-1"
            width="24"
            height="24"
            viewBox="0 0 24 24"
            fill="none"
        ...
        <button
          ...
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="xt-icon text-base -my-1 ml-1"
            width="24"
            height="24"
            viewBox="0 0 24 24"
            fill="none"
        ...
        <button
          ...
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="xt-icon text-xl -my-1 ml-1"
            width="24"
            height="24"
            viewBox="0 0 24 24"
            fill="none"
      ...
      <div className="xt-list xt-list-3 items-center">
        <button
          ...
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="xt-icon text-xs ml-1.5"
            width="24"
            height="24"
            viewBox="0 0 24 24"
            fill="none"
        ...
        <button
          ...
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="xt-icon text-base ml-1.5"
            width="24"
            height="24"
            viewBox="0 0 24 24"
            fill="none"
        ...
        <button
          ...
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="xt-icon text-xl -my-1 ml-1.5"
            width="24"
            height="24"
            viewBox="0 0 24 24"
            fill="none"
      ...
      <div className="xt-list xt-list-3 items-center">
        <button
          type="button"
          className="xt-button text-base py-2.5 px-4 rounded-md text-white font-semibold leading-snug tracking-wider uppercase bg-primary-500 transition hover:bg-primary-600 active:bg-primary-700 on:bg-primary-700">
          icon small{' '}
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="xt-icon text-xs ml-2"
            width="24"
            height="24"
            viewBox="0 0 24 24"
            fill="none"
        ...
        <button
          ...
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="xt-icon text-base ml-2"
            width="24"
            height="24"
            viewBox="0 0 24 24"
            fill="none"
