    ...
    <div>
      <div className="xt-list xt-list-3 items-center">
        <div data-xt-drop="{ duration: 500 }">
          ...
          <div
            className="xt-drop p-4 *** transition opacity-0 -translate-x-4 in:opacity-100 in:translate-x-0 out:translate-x-4 ***"
            data-xt-drop-target>
        ...
        <div data-xt-drop="{ duration: 500 }">
          ...
          <div
            className="xt-drop p-4 group *** transition opacity-0 -translate-x-4 in:opacity-100 in:translate-x-0 out:translate-x-4 ***"
            data-xt-drop-target>
