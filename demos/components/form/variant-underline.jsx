      ...
      <form className="text-sm">
        <div className="xt-row xt-row-x-6 xt-row-y-4">
          <div className="w-full">
            ...
            <input
              type="text"
              className="block w-full py-2 text-black placeholder-black placeholder-opacity-50 border-b-2 border-gray-200 bg-transparent transition focus:border-gray-300"
              aria-label="Input"
              placeholder="Input"
            />
          </div>
          ...
          <div className="w-full">
            ...
            <textarea
              className="block w-full h-20 max-h-48 py-2 text-black placeholder-black placeholder-opacity-50 border-b-2 border-gray-200 bg-transparent transition focus:border-gray-300 h-24 resize-vertical"
              aria-label="Textarea"
          ...
          <div className="w-full">
            ...
            <select
              className="block w-full xt-select py-2 text-black placeholder-black placeholder-opacity-50 border-b-2 border-gray-200 bg-transparent transition focus:border-gray-300"
              aria-label="Select">
