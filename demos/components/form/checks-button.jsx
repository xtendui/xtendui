  ...
  return (
    <div>
      <div className="xt-list xt-list-3 items-center">
        <label className="xt-button text-xs py-2.5 px-3.5 rounded-md text-black font-semibold leading-snug tracking-wider uppercase bg-gray-200 transition hover:bg-gray-300 active:bg-gray-400 on:bg-gray-400 focus-within:outline-browser">
          Lorem ipsum
          <input
            type="checkbox"
