      ...
      <form className="text-sm">
        <div className="xt-list xt-list-2">
          <div className="xt-list-inner flex-auto">
            ...
            <input
              type="text"
              className="block w-full rounded-r-md py-2 px-4 text-black placeholder-black placeholder-opacity-75 bg-gray-300 transition focus:bg-gray-500 focus:outline-none"
              aria-label="Search"
