    ...
    <div>
      <form className="text-sm">
        <button type="button" className="xt-list group">
          <div className="xt-button text-xs py-2.5 px-3.5 rounded-l-md text-white font-semibold leading-snug tracking-wider uppercase bg-primary-500 transition hover:bg-primary-600 group-hover:bg-primary-600">
            Search
          </div>
