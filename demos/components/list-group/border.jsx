      ...
      <form className="text-sm">
        <div className="xt-list flex-nowrap">
          <div className="xt-list-inner flex-auto">
            ...
            <input
              type="text"
              className="block w-full border border-l-0 border-gray-500 py-2.5 px-4 text-black placeholder-black placeholder-opacity-50 border border-gray-200 bg-gray-200 transition focus:bg-gray-300"
              aria-label="Search"
