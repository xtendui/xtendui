    ...
    <div>
      <form className="text-sm">
        <button type="button" className="xt-list flex-col group">
          ...
          <div className="xt-button text-xs py-2.5 px-3.5 rounded-b-md text-black font-semibold leading-snug tracking-wider uppercase bg-gray-200 transition hover:bg-gray-300 group-hover:bg-gray-300">
            <svg
