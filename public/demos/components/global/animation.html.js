...
const html = /* HTML */ `
  <div class="demo--javascript-animation">
    <button
      ...
      Lorem ipsum
      <span
        class="absolute inset-0 flex items-center justify-center text-white bg-black/50 *** off:hidden out:pointer-events-none transition opacity-0 -translate-x-4 in:opacity-100 in:translate-x-0 out:translate-x-4 ***"
