  ...
  mount: ({ ref }) => {
    ...
    new Xt.Toggle(toggle, {
      ...
      const addFnc = () => {
        ...
        const strEl = `<button type="button" class="xt-button py-2 px-3 text-13 rounded-full font-medium leading-snug text-gray-900 bg-gray-100 transition hover:bg-primary-300/25 active:text-white active:bg-primary-500 on:text-white on:bg-primary-500 on dir-before in done" data-xt-toggle-element>Toggle ${index}</button>`
